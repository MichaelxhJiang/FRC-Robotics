...
public class ArmPosForExchangeCmd  extends Command {
	private static final int exeTime = 1000;	//1 second(1000ms) to get reset position

	private Encoder j3Encoder  = RobotMap.jointEncoder3;

	public ArmPosForExchangeCmd() {
		Robot.joint3Cmd = new Joint3Cmd(j3Encoder.getRaw(), (int)(0.0/360.0 * Robot.SHOVEL_CIRCLE_CNT), exeTime);
