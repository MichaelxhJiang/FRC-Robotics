...
public class ArmReleaseCubeCmd  extends Command {
	private static final int RUN_TIME1 = 300;	//300ms down
	private static final int RUN_TIME2 = 100;	//100ms up
	private Encoder j3Encoder  = RobotMap.jointEncoder3;
	private int step = 0;
	private static final double SWITCH_ANGLE1 = 40.0;
	...
	protected void execute() {
		if ((step == 0) && Robot.joint3Cmd.isFinished()) {
			step = 1;
