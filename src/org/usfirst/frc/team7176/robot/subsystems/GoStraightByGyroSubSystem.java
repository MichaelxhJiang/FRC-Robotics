...
public class GoStraightByGyroSubSystem extends PIDSubsystem{
	...
	public GoStraightByGyroSubSystem(double driveVel) {
		super("GoStraightByGyro", 0.09, 0.0, 0.0);// 0.09kP on carpet. The constructor passes a name for the subsystem and the P, I and D constants that are used when computing the motor output
