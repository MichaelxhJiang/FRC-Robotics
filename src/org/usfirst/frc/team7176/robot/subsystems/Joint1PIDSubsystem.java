...
public class Joint1PIDSubsystem extends PIDSubsystem { // This system extends PIDSubsystem
	...
	public Joint1PIDSubsystem() {
		super("Joint1", 0.03, 0.0, 0.0);// The constructor passes a name for the subsystem and the P, I and D constants that are used when computing the motor output
    ...
    protected void usePIDOutput(double output) {
    	...
    	//motor.pidWrite(1.0); // this is where the computed output value from the PIDController is applied to the motor
    }
